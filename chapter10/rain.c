// находит суммарные данные по годам, средние значения за год и средние
// значение за месяц по данным об осадках за несколько лет
#include <stdio.h>
#define MONTHS 12	// количество месяцев в году
#define YEARS 5		// количество лет, для которых доступны данные

int rain(void) {
	// инициализация данными об осдках за период с 2010 по 2014 гг.
	...
	for(year = 0, total = 0; year < YEARS; year++) {
		...
		printf("%5d\t%15.1f\n", 2010 + year, subtot);
		total += subtot; // общая сумма всех лет
	}
