...
int dualview(void) {
	...
	printf("\nSettings of window with using presenting unsigned short:\n");
	show_settings1(box.us_view);
	
	printf("combination of bites %s\n",
...
void show_settings1(unsigned short us) {
	printf("Window %s.\n",
		(us & OPAQUE) == OPAQUE ? "untransparently" : "transparently");
	printf("Color of background %s.\n", colors[(us >> 1) & 07]);
	printf("Borders %s.\n",
		(us & BORDER) == BORDER ? "displayed" : "no displayed");
